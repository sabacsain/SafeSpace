...
const Home = () => {
  return (
    ...
    <div className='relative flex items-center gap-16 w-full h-[95vh] pl-16 -mt-[3vh]'>
      ...
      <img src={landing1} className='absolute right-0 top-0 w-[32vw] h-auto -z-10' />
      <img src={landing2} className='absolute right-0 bottom-0 w-[43.5vw] h-[47.5vh] -z-10' />
    </div>
    ...
    <div id='testimonials' className='flex flex-col justify-center items-center gap-10 w-full h-screen'>
      <h1 className='-mt-24 text-secondary-200 text-4xl font-bold'>Testimonials</h1>
