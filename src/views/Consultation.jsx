...
const Consultation = () => {
  ...
  return (
    <>
    <Banner title='NEED a CONSULTATION?' image='/banner/consultation-overlay.jpg'  description='Consultation provides expert advice and guidance on various matters, offering personalized solutions and support.'/>
      ...
      <div className='flex flex-col justify-center items-center w-5/6 h-2/3 bg-[url("/src/assets/consultation/form.png")] bg-cover bg-center border-secondary-200 border-8'>
        ...
        >
          <div className='flex justify-evenly gap-10'>
            <label for='psychologist' className='flex flex-col w-52 text-lg font-semibold'>
